...
/* =========================================================
   GRILLE D'OFFRES PLA — SOURCE DE VÉRITÉ
========================================================= */
const offerStructure = [
  {
    label: "🏁 Pilotes",
    options: [
      { value: "starter-image", label: 'Pack "Starter Image" — à partir de 490 €' },
      { value: "recherche-partenaires", label: 'Pack "Recherche Partenaires" — 15 % de commission sur le sponsoring obtenu' },
      { value: "accompagnement-saison", label: 'Accompagnement Saison — sur devis' }
    ]
  },
  {
    label: "🚗 Écuries",
    options: [
      { value: "visibilite-reseaux", label: 'Pack "Visibilité Réseaux" — à partir de 690 €/mois' },
      { value: "ecurie-media", label: 'Écurie-Média — sur devis' }
    ]
  },
  {
    label: "🏟️ Circuits",
    options: [
      { value: "boost-digital", label: 'Pack "Boost Digital" — à partir de 890 €' },
      { value: "circuit-360", label: 'Circuit 360 — sur devis' }
    ]
  },
  {
    label: "🏢 Marques & entreprises",
    options: [
      { value: "mise-en-relation", label: 'Pack "Mise en Relation" — à partir de 590 €' },
      { value: "partenariat-sur-mesure", label: 'Partenariat Sur-Mesure — sur devis' }
    ]
  },
  {
    label: "🏆 Événementiel",
    options: [
      { value: "evenement-local", label: 'Événement Clé en Main — Format Local — à partir de 1 500 €' },
      { value: "evenement-etendu", label: 'Événement Clé en Main — Format Étendu — à partir de 3 500 €' },
      { value: "creation-evenement", label: "Création d'Événement Sur-Mesure — sur devis" }
    ]
  },
  {
    label: "💼 Prestation de services externe",
    options: [
      { value: "communication-marketing", label: 'Pack "Communication & Marketing" — à partir de 790 €/mois' },
      { value: "developpement-commercial", label: 'Pack "Développement Commercial" — à partir de 890 €/mois' },
      { value: "accompagnement-global", label: "Accompagnement Global — sur devis" }
    ]
  }
];
...
function initForm() {
  ...
  form.addEventListener("submit", e => {
    ...
    const offerField = form.querySelector("[name='offer']");
    const offer = offerField?.selectedOptions?.[0]?.textContent?.trim() ||
...
function initOfferSelect() {
  ...
  placeholder.value = "";
  placeholder.textContent = "Sélectionnez une offre...";
  select.appendChild(placeholder);

  offerStructure.forEach(group => {
    ...
    group.options.forEach(opt => {
      ...
      if (currentValue && currentValue === opt.value) option.selected = true;
...
function initPortalAccess() {
  ...
  const clients = {
    "adminpitlane2025": {
      ...
      project: "Gestion globale des offres PLA",
      status: "Pilotage agence",
      progress: 100,
      links: [
        {
          title: "Pipeline offres PLA",
          desc: "Suivi global des leads et projets par catégorie.",
          url: "#"
        },
        {
          title: "Drive offres & contrats",
          desc: "Documents internes, devis, contrats et supports.",
          url: "#"
        },
        {
          title: "Reporting clients",
          desc: "Accès aux reportings mensuels et suivis de mission.",
          url: "#"
        },
        {
          title: "Planning éditorial",
          desc: "Calendrier global des contenus et activations.",
          url: "#"
        }
      ],
      tasks: [
        ['Pack "Starter Image" — Romain', "En cours"],
        ['Pack "Recherche Partenaires" — Nathan & Rémy', "À relancer"],
        ['Événement Clé en Main — Nathan 205', "Brief à compléter"],
    ...
    "romain2025": {
      ...
      project: 'Accompagnement Saison',
      status: "En cours",
      progress: 75,
      links: [
        {
          title: 'Book "Starter Image"',
          desc: "Document de présentation pilote : palmarès, storytelling, positionnement.",
          url: "#"
        },
        {
          title: "Kit médias",
          desc: "Photos, bio, éléments presse et visuels sociaux.",
          url: "#"
        },
        {
          title: "Calendrier contenus",
          desc: "Planning éditorial ambassadeur / saison.",
          url: "#"
        }
      ],
      tasks: [
        ['Pack "Starter Image"', "Validé"],
        ["Photos officielles", "En cours"],
        ["Kit médias", "À finaliser"]
      ]
    },
    ...
    "nathanrallye2025": {
      ...
      project: 'Pack "Recherche Partenaires"',
      status: "Prospection active",
      progress: 60,
      links: [
        {
          title: "Dossier sponsoring",
          desc: "Book + présentation commerciale pour les partenaires.",
          url: "#"
        },
        {
          title: "Liste sponsors",
          desc: "Suivi des entreprises ciblées pour la prospection.",
          url: "#"
        },
        {
          title: "Planning rallye",
          desc: "Calendrier prévisionnel de saison et activations.",
          url: "#"
        },
        {
      ...
      tasks: [
        ['Pack "Starter Image"', "En cours"],
        ["Liste sponsors", "En cours"],
    ...
    "nathan205raid2025": {
      ...
      project: 'Création d\'Événement Sur-Mesure',
      status: "Préparation dossier",
      progress: 45,
      links: [
        {
          title: "Dossier solidaire",
          desc: "Dossier sponsor orienté RSE et impact.",
          url: "#"
        },
        {
          title: "Planning contenu",
          desc: "Stratégie avant, pendant et après le raid.",
          url: "#"
        },
        {
          title: "Liste sponsors RSE",
          desc: "Entreprises et partenaires à prospecter.",
          url: "#"
        }
      ],
      tasks: [
        ...
        ["Devis événement sur-mesure", "À produire"]
      ]
    }
  };
  ...
  function renderPortal(data) {
    ...
    if (tasksWrap) {
      tasksWrap.innerHTML = data.tasks.map(([label, status]) => {
        ...
        if (s.includes("validé") || s.includes("terminé")) cls = "done";
        else if (s.includes("cours")) cls = "progress";
